...
#define uint32_t  cMyUint32_t

#define __IO

extern MDR_RST_CLK_TypeDef *MdrRstSlk;

extern MDR_PORT_TypeDef *MdrPortA;
extern MDR_PORT_TypeDef *MdrPortB;
extern MDR_PORT_TypeDef *MdrPortC;
extern MDR_PORT_TypeDef *MdrPortD;
extern MDR_PORT_TypeDef *MdrPortE;
extern MDR_PORT_TypeDef *MdrPortF;

extern MDR_TIMER_TypeDef *MdrPortTimer1;
extern MDR_TIMER_TypeDef *MdrPortTimer2;
extern MDR_TIMER_TypeDef *MdrPortTimer3;

extern MDR_CAN_TypeDef *MdrCan1;
extern MDR_CAN_TypeDef *MdrCan2;
...
#define MDR_CAN1_BASE       MdrCan1 // (0x40000000)
#define MDR_CAN2_BASE       MdrCan2 // (0x40008000)
#define MDR_USB_BASE        (0x40010000)
#define MDR_EEPROM_BASE     (0x40018000)
#define MDR_RST_CLK_BASE    MdrRstSlk//(0x40020000)
...
#define MDR_TIMER1_BASE     MdrPortTimer1 // (0x40070000)
#define MDR_TIMER2_BASE     MdrPortTimer2 // (0x40078000)
#define MDR_TIMER3_BASE     MdrPortTimer3 // (0x40080000)
...
#define  MDR_PORTA_BASE		MdrPortA//		(0x400A8000)
#define  MDR_PORTB_BASE		MdrPortB//      (0x400B0000)
#define  MDR_PORTC_BASE		MdrPortC//      (0x400B8000)
#define  MDR_PORTD_BASE		MdrPortD//      (0x400C0000)
#define  MDR_PORTE_BASE		MdrPortE//      (0x400C8000)
#define MDR_BKP_BASE        (0x400D8000)
#define MDR_PORTF_BASE		MdrPortF//(0x400E8000)
